...
async function generateHashedId() {
	...
	// NOTE: osVersion remove because it is unreliable for some devices
	const dataToHash = `${ip}-${deviceDetails.os}-${deviceDetails.screenWidth}-${deviceDetails.screenHeight}-${deviceDetails.timezone}-${deviceDetails.timezoneOffset}`; // Combine for hashing
